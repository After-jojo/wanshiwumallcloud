...
public class ProductVO extends Product {
    ...
    public ProductVO(String productId, String productName, Integer categoryId, Integer rootCategoryId, Integer soldNum, Integer productStatus, Date createTime, Date updateTime, String content, List<ProductImg> imgs, List<ProductSku> skus) {
        this.productId = productId;
        this.productName = productName;
        this.categoryId = categoryId;
        this.rootCategoryId = rootCategoryId;
