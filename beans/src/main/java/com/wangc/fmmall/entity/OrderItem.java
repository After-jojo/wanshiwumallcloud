...
public class OrderItem {
    ...
    public OrderItem(String itemId, String orderId, String productId, String productName, String productImg, String skuId, String skuName, double sellPrice, int cartNum, double v, Date date, Date date1, int i) {
    }
